...
import 'package:interview_task/phone_field_package/country_picker_dialog.dart';
import 'package:interview_task/phone_field_package/helpers.dart';
        ...
        child: Padding(
          ...
          child: Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(30),
              border: Border.all(color: AppThemeData.kBorderColor, width: 1.3),
            ),
            child: Row(
